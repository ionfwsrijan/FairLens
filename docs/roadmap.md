...
- Real UCI Adult Income and Statlog German Credit datasets, no generated training rows.
- Baseline model, protected-group audit, SHAP explainability, Fairlearn mitigation.
- Dataset profiling, slice diagnostics, decision-review queue, policy gates, governance model card, AI report export, and guided demo flow.
- Docker and Cloud Run deployment path.

## Next Product Improvements

1. **More dataset connectors**
   Add carefully documented COMPAS-style and healthcare-readmission demos with a dataset selector, while keeping each dataset real and historically documented.
...
4. **Human review workflow**
   Add reviewer assignment, decision override reason codes, Firebase-backed audit logs, and approval routing.
